...
/**
 * {@link ByteBuffersDataOutput}
 * 以 ByteBuffer 作为存储的 DataOutput
 * @author com.lioyan
 * @date 2023/6/6  11:41
 */
public class ByteBuffersDataOutput extends DataOutput implements Accountable {
    ...
    public long ramBytesUsed() {
        ...
        assert ramBytesUsed == blocks.stream().mapToLong(ByteBuffer::capacity).sum() + blocks.size() * 3;
        return ramBytesUsed;
    }
    ...
    private void appendBlock() {
        ...
        ramBytesUsed += 4 + currentBlock.capacity();
    }
    ...
    private static final int SURROGATE_OFFSET =3;
